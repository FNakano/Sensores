  ...
  DateTime now;
      ...
      case 'q':
        //BMP280
          ...
          Serial.println(bmp.readAltitude(1013.25)); // this should be adjusted to your local forcase
      ...
      case 'r':
          ...
          Serial.println(sensors.getTempFByIndex(0)); //Lê-se e imprime a temperatura en graus Fahrenheit
          Serial.println();
          delay(200);
        break;
      case 't':
